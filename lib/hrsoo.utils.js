...
var aliases = {
    ...
    timezones: { // todo: there are many more timezones...
        est: ['et', 'edt', 'eastern'],
        cst: ['ct', 'cdt', 'central'],
        mst: ['mt', 'mdt', 'mountain'],
        pst: ['pt', 'pdt', 'pacific']
    ...
    days: {
        monday:     ['m', 'mo', 'mon', 'mom', 'mond', 'mnd'],
        tuesday:    ['t', 'tu', 'tue', 'tues', 'tus'],
        wednesday:  ['w', 'we', 'wed', 'weds', 'wedn', 'wdn'],
        thursday:   ['t', 'th', 'thu', 'thur', 'thurs', 'thr', 'thrs'],
        friday:     ['f', 'fr', 'fri', 'frid', 'frd'],
        saturday:   ['s', 'sa', 'sat'],
        sunday:     ['s', 'su', 'sun']
    }
};
